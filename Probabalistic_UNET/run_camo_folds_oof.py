...
# ---- Hard-coded paths ----
BASE = "/scratch/general/nfs1/u1528328/img_dir/Camoflage_10-1"                
CHECKPOINTS_ROOT = "/scratch/general/nfs1/u1528328/img_dir/Camoflage_10-1/checkpoints"
RESULTS_DIR_SCRATCH = "/scratch/general/nfs1/u1528328/img_dir/Camoflage_10-1/results"
METRICS_DIR = "/scratch/general/nfs1/u1528328/img_dir/Camoflage_10-1/metrics"
...
def main():
    ...
    for k in range(0, 5):
        ds_name = f"camo_fold{k}"
        dataroot = os.path.join(BASE, "camo_folds", f"fold{k}")
    ...
    if all_metrics:
        master_name = os.path.join(METRICS_DIR, "master_metrics_camo_folds.csv")
